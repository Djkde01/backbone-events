...
const FileUploader = (
    ...
    return (
        <div {...getRootProps()} className="flex items-center justify-center bg-dark-3 flex h-72 cursor-pointer flex-col overflow-hidden rounded-xl bg-grey-50">
            <input {...getInputProps()} />
            {imageUrl ? (
                ...
                <div className="flex items-center justify-center flex-col py-5 text-grey-500">
                    ...
                    <h3 className="mb-2 mt-2">Arrastra una foto aquí</h3>
